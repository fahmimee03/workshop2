...
# Function to extract month names and charges using index-based alignment
def extract_months_and_charges(charges_text):
    # Regex patterns for months and charges
    month_pattern = r"[A-Z]{3}-\d{2}"  # Matches months like MEI-24, JUN-24, etc.
    charge_pattern = r"RM[0-9,\.]+"  # Matches charges like RM370.75

    # Extract all months and charges
    months = re.findall(month_pattern, charges_text)
    charges = re.findall(charge_pattern, charges_text)

    # Align months and charges by index
